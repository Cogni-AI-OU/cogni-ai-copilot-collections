...
| `/cogni-ai-git-ops:git` | Load the git skill — Guide for using git with non-interactive, safe operations. Includes references for reflog, bisecting, merges, rebase, and recovery |
