...
For the C++ coding standards click [here](../cpp-coding-standard/SKILL.md).
...
1.  [**Names**](#names)
    ...
    -   [Enum Names](#enames)
    -   [#define and Macro Names](#mnames)

    []{#docidx}
2.  [**Formatting**](#formatting)
    -   *(important recommendations below)*
    -   [Brace *{}* Policy](#brace)
    -   [Parens *()* with Key Words and Functions Policy](#parens)
    -   [A Line Should Not Exceed 78 Characters](#linelen)
    -   [*If Then Else* Formatting](#ifthen)
    -   [*switch* Formatting](#switch)
    -   [Use of *goto,continue,break* and *?:*](#goto)
    -   *(other suggestions below)*
