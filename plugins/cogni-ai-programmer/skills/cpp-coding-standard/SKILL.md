...
For the C coding standards click [here](../c-coding-standard/SKILL.md).

------------------------------------------------------------------------

# Contents

1.  [**Resources- Take a Look!**](CppCodingStandard.html#resources)
2.  [**Names**](CppCodingStandard.html#names)
    -   *(important recommendations below)*
    -   [Include Units in Names](CppCodingStandard.html#units)
    -   [Class Names](CppCodingStandard.html#classnames)
    -   [Class Library Names](CppCodingStandard.html#classlnames)
    -   [Method Names](CppCodingStandard.html#methodsnames)
    -   [Class Attribute Names](CppCodingStandard.html#attrnames)
    -   [Method Argument Names](CppCodingStandard.html#margnames)
    -   [C++ File Extensions](CppCodingStandard.html#fext)
    -   [C Function Names](CppCodingStandard.html#cnames)
    -   *(other suggestions below)*
    -   [Make Names Fit](CppCodingStandard.html#descriptive)
    -   [Variable Names on the Stack](CppCodingStandard.html#stacknames)
    -   [Pointer Variables](CppCodingStandard.html#pnames)
    -   [Reference Variables and Functions Returning
        References](CppCodingStandard.html#rnames)
    -   [Global Variables](CppCodingStandard.html#gnames)
    -   [Global Constants](CppCodingStandard.html#gconstants)
    -   [Static Variables](CppCodingStandard.html#snames)
    -   [Type Names](CppCodingStandard.html#tnames)
    -   [Enum Names](CppCodingStandard.html#enames)
    -   [#define and Macro Names](CppCodingStandard.html#mnames)

    []{#docidx}
3.  [**Formatting**](CppCodingStandard.html#formatting)
    -   *(important recommendations below)*
    -   [Brace *{}* Policy](CppCodingStandard.html#brace)
    -   [Parens *()* with Key Words and Functions
        Policy](CppCodingStandard.html#parens)
    -   [A Line Should Not Exceed 78
        Characters](CppCodingStandard.html#linelen)
    -   [*If Then Else* Formatting](CppCodingStandard.html#ifthen)
    -   [*switch* Formatting](CppCodingStandard.html#switch)
    -   [Use of *goto,continue,break* and
        *?:*](CppCodingStandard.html#goto)
    -   *(other suggestions below)*
    -   [One Statement Per Line](CppCodingStandard.html#one)
    -   [Alignment of Declaration
        Blocks](CppCodingStandard.html#aligndecls)
4.  [**Classes**](CppCodingStandard.html#classes)
    -   *(important recommendations below)*
    -   [Naming Class Files](CppCodingStandard.html#cflayout)
    -   [Class Layout](CppCodingStandard.html#classlayout)
    -   [Order of
        public/protected/private?](CppCodingStandard.html#pubpropriorder)
    -   [What should go in
        public/protected/private?](CppCodingStandard.html#pubpropri)
    -   [Required Methods for a Class](CppCodingStandard.html#req)
    -   [Method Layout](CppCodingStandard.html#mlayout)
    -   [Use of Namespaces](CppCodingStandard.html#namespace)
    -   [Use Header File Guards](CppCodingStandard.html#guards)
    -   *(other suggestions below)*
    -   [Different Accessor Styles](CppCodingStandard.html#accessor)
    -   [Initialize all Variables](CppCodingStandard.html#initvar)
    -   [Think About What Work to do in
        Constructors](CppCodingStandard.html#work)
    -   [Be Careful Throwing Exceptions in
        Destructors](CppCodingStandard.html#destexcept)
5.  [**Documentation**](CppCodingStandard.html#documentation)
    -   *(important recommendations below)*
    -   [Comments Should Tell a Story](CppCodingStandard.html#cstas)
    -   [Document Decisions](CppCodingStandard.html#cdd)
    -   [Use Headers](CppCodingStandard.html#cuh)
    -   [Make Gotchas Explicit](CppCodingStandard.html#mge)
    -   [Commenting function declarations](#cdef)
    -   *(other suggestions below)*
    -   [Include Statement Documentation](CppCodingStandard.html#idoc)
6.  [**Complexity Management**](CppCodingStandard.html#complexity)
    -   [Layering](CppCodingStandard.html#layering)
    -   [Delegation](CppCodingStandard.html#delegation)
    -   [Minimize Dependencies with Abstract Base
        Classes](CppCodingStandard.html#abstract)
    -   [Liskov\'s Substitution
        Prinicple](CppCodingStandard.html#liskov)
    -   [Follow the Law of Demeter](CppCodingStandard.html#demeter)
7.  [**Miscellaneous**](CppCodingStandard.html#miscellaneous)
    -   [Be Const Correct](CppCodingStandard.html#const)
    -   [Use Streams](CppCodingStandard.html#streams)
    -   [Use #if Not #ifdef](CppCodingStandard.html#ifdef)
    -   [Commenting Out Large Code Blocks](CppCodingStandard.html#if0)
    -   [Don\'t Over Use Operators](CppCodingStandard.html#nooper)
    -   [Short Methods](CppCodingStandard.html#shortmethods)
    -   [No Magic Numbers](CppCodingStandard.html#nomagic)
    -   [Error Return Check Policy](CppCodingStandard.html#errorret)
    -   [To Use Enums or Not to Use
        Enums](CppCodingStandard.html#useenums)
    -   [Macros](CppCodingStandard.html#macros)
    -   [The Bull of Boolean Types](CppCodingStandard.html#boolean)
    -   [Usually Avoid Embedded
        Assignments](CppCodingStandard.html#eassign)
    -   [Mixing C and C++](CppCodingStandard.html#callc)
    -   [Miscellaneous](CppCodingStandard.html#misc)
    -   [No Data Definitions in Header
        Files](CppCodingStandard.html#nodef)
    -   [Make Functions Reentrant](CppCodingStandard.html#reentrant)
