...
- **Marketplaces:** Claude Code supports external plugin marketplaces added via `/plugin marketplace add <url>`. See the **dot-claude** skill for detailed marketplace configuration and security guidance.
